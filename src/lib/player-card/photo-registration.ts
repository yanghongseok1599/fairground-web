...
export const PLAYER_CARD_PHOTO_OPTIONS = [
  { mode: "face", label: "내 얼굴 등록하기", description: "내 얼굴을 준타스 유니폼에 합성해요" },
  { mode: "uniform", label: "내 유니폼프로필 등록하기", description: "내 유니폼과 모습을 그대로 사용해요" },
] as const;

export const JUNTAS_CARD_POSES = Object.freeze({
  male: "/images/player-card-poses/juntas-male-01.png",
  female: "/images/player-card-poses/juntas-female-01.png",
});
