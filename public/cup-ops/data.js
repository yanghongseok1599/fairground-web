...
export const sponsorReelGuides = [
  {
    ...
    concept: '경기 전 준비 루틴 — 제품을 준비하고 팀과 함께 코트로 향하는 흐름', timing: '경기 전 준비·경기 사이 휴식',
    shots: ['패키지와 맛 이름이 읽히는 정면 컷', '가방에서 제품을 꺼내는 손', '물에 타고 흔드는 과정', '경기장 배경으로 한 모금 마시는 장면', '동료와 웃으며 다음 경기를 준비하는 와이드 컷'],
